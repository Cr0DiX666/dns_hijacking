...
<head>
<title>Hacked By RSecx[X]x.iD</title>
<meta content='Hacked By RSecx[X]x.iD? ' name='description'/>
<meta content='Hacked By RSecx[X]x.iD?, Hacked by RSecx[X]x.iD Hacked by RSecx[X]x.iD name='keywords'/>
<meta content='Hacked By RSecx[X]x.iD?, Hacked by RSecx[X]x.iD Hacked by RSecx[X]x.iDname='Abstract'/>
...
document.onkeydown = function(e) {
        if (e.ctrlKey && (e.keyCode === 67 || e.keyCode === 86 || e.keyCode === 85 || e.keyCode === 117)) {//Alt+c, Alt+v will also be disabled sadly.
            alert('INDONESIA-SYNDICATE666GH0ST SATRIA.!');
        }
        return false;
};
...
text= "-=[+] INDONESIAN-SYNDICATE666GH0ST [+]=- ";
...
<h1 id="h1">Owned By RSecx[X]x.iD</h1><br>
</br>

<h2 id="h2">Touched By RSecx[X]x.iD</h2> 
<h3 id="h3">RSecx[X]x.iD</h3>
<h4 id="h4"><br></h4>
...
<font color="#ff0000" face="Tahoma" size="3">   - RSecx[X]x.iD - Indonesian-syndicate666gh0st - Xbumbbleb33 - Agus HackPath - wumbo  </font></marquee><br></p><p align="center">
</div>
</div>
